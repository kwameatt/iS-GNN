...
class IGNNK_ModOptionB(nn.Module):
    ...
    def __init__(self, h_total, h_target, z, k, dropout=0.0):
        ...
        self.GNN1 = D_GCN(self.h_total, self.z, self.k)
        self.GNN2 = D_GCN(self.z, self.z, self.k)
    ...
    def forward(self, X, A_q, A_h):
        ...
        X_s1 = self.GNN1(X_S, A_q, A_h)
        X_s2 = self.GNN2(self.drop(X_s1), A_q, A_h) + X_s1
        X_s3 = self.GNN3(self.drop(X_s2), A_q, A_h)
