...
data0="../iS-GNN_grid_0p2r_results_ep_150_bs64_lr5em04_z96_k_diff_1_kNN_8_ramps_30_b_cap_90.csv"
...
gmt plot "$bars0" -SV0.0c+e0c -W0.8p,red -Gred@60 -L
