...
# data0="/mnt/e/GNN_paper/2025_IGNNK/data/grids_interp/iS-GNN_grid_0p2r_results_2.csv"
data0="../iS-GNN_grid_0p5r_results_ep_150_bs64_lr_5em04_k_diff_1_kNN_12_kernel_r_0_75_w_0_7em01.csv"
data1="../iS-GNN_anchor_0p5r_results_ep_150_bs64_lr_5em04_k_diff_1_kNN_12_kernel_r_0_75_w_0_7em01.csv"
...
# gmt makecpt -Cred,orange,yellow,yellowgreen,green -T0/1/.2 -Z > grid_colors.cpt
gmt makecpt -Cgreen,yellowgreen,yellow,orange,red -T0/1/.2 -Z > grid_colors.cpt
...
gmt begin "$image_fname" png
  ...
  gmt colorbar -Cgrid_colors.cpt -DjBC+w8c/0.6c+o0/0.6c+h -Bxaf+l"Interpolation strength"

  gmt legend -DjTC+w11c+o0.3c/0.3c -F+p1p,black+gwhite@20+r0.2c<< EOF
